...
cjfee_a = 2000             # [satoshis, any integer] / absolute offer fee you wish to receive for coinjoins (cj)
...
txfee = 500               # [satoshis, any integer] / the average transaction fee you're adding to coinjoin transactions
